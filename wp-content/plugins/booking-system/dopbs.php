...
Change log:
		...
		* Hours' reservations don't overlap when you use the WooCommerce cart, bug repaired.
        ...
        2.1.9 (2016-03-29)
                ...
                * "Add-ons" activation has been improved. You can delete an activation from https://shop.dotonpaper.net/my-account/ if you have deleted the add-on and you have not deactivated it or if you want to activate it on another domain. Also the notification disappears after what the update is completed.
...
*/
    ...
    if (!class_exists('DOPBSP')){
        class DOPBSP{
			...
			$this->vars->view_pro ? add_submenu_page('dopbsp', $this->text('LOCATIONS_TITLE').' - '.$this->text('MESSAGES_PRO_TEXT'), $this->text('LOCATIONS_TITLE').'<em class="dopbsp-small dopbsp-beta"> '.$this->text('MESSAGES_PRO_INFO').'</em>', $this->vars->role_action, 'dopbsp-pro', array(&$this->classes->backend_pro, 'view')):'';
